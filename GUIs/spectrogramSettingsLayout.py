...
class Ui_spectrogramSettingsWidget(object):
    def setupUi(self, spectrogramSettingsWidget):
        ...
        spectrogramSettingsWidget.resize(263, 144)
        ...
        spectrogramSettingsWidget.setMinimumSize(QtCore.QSize(263, 144))
        spectrogramSettingsWidget.setMaximumSize(QtCore.QSize(263, 144))
        self.widget = QtWidgets.QWidget(spectrogramSettingsWidget)
        self.widget.setGeometry(QtCore.QRect(9, 9, 245, 126))
        ...
        self.gridLayout.addWidget(self.resetSetings_btn, 4, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.saveSettings_btn, 4, 1, 1, 1)
