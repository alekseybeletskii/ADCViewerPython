...
class Ui_spectrogramSettingsWidget(object):
    def setupUi(self, spectrogramSettingsWidget):
        ...
        self.widget.setGeometry(QtCore.QRect(0, 10, 644, 223))
        ...
        self.fs_kHz_ui = QtWidgets.QLabel(self.widget)
        self.fs_kHz_ui.setFrameShape(QtWidgets.QFrame.WinPanel)
        self.fs_kHz_ui.setFrameShadow(QtWidgets.QFrame.Sunken)
    ...
    def retranslateUi(self, spectrogramSettingsWidget):
        ...
        self.fs_kHz_ui.setText(_translate("spectrogramSettingsWidget", "1"))
