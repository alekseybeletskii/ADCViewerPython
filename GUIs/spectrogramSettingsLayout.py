...
class Ui_spectrogramSettingsWidget(object):
    def setupUi(self, spectrogramSettingsWidget):
        ...
        spectrogramSettingsWidget.resize(650, 310)
        ...
        spectrogramSettingsWidget.setMinimumSize(QtCore.QSize(650, 310))
        spectrogramSettingsWidget.setMaximumSize(QtCore.QSize(650, 310))
        self.layoutWidget = QtWidgets.QWidget(spectrogramSettingsWidget)
        self.layoutWidget.setGeometry(QtCore.QRect(20, 10, 644, 293))
        ...
        self.gridLayout.addWidget(self.label_4, 0, 4, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.gridLayout.addWidget(self.label_14, 5, 2, 1, 2, QtCore.Qt.AlignRight)
        ...
        self.gridLayout.addWidget(self.targetFrq_kHz_ui, 5, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_17, 7, 2, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.gridLayout.addWidget(self.label_18, 7, 4, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.gridLayout.addWidget(self.line_6, 12, 0, 1, 8)
        ...
        self.gridLayout.addWidget(self.exportSpectrogramToImg_ui, 13, 1, 1, 1)
        self.line_7 = QtWidgets.QFrame(self.layoutWidget)
        self.line_7.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_7.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_7.setObjectName("line_7")
        self.gridLayout.addWidget(self.line_7, 14, 0, 1, 8)
        ...
        self.gridLayout.addWidget(self.getFromUiApplyAndClose_btn, 15, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.saveSettings_btn, 15, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.resetSetings_btn, 15, 7, 1, 1)
