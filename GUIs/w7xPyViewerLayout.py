...
class Ui_w7xPyViewer(object):
    def setupUi(self, w7xPyViewer):
        ...
        self.groupBox.setMinimumSize(QtCore.QSize(600, 22))
        self.groupBox.setMaximumSize(QtCore.QSize(600, 22))
        ...
        self.mouseXY_UI.setGeometry(QtCore.QRect(360, 0, 250, 20))
